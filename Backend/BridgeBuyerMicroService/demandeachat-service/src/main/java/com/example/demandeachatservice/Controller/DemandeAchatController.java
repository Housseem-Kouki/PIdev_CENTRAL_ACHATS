...
public class DemandeAchatController {
    ...
    @GetMapping("/getDemandeAchatByAcheteurCurrent/{id}")
public  List<DemandeAchat> getDemandeAchatByAcheteurCurrent(@PathVariable("id") int id){
  // User acheteur = userRepository.getById(id);
   List<DemandeAchat> demandeAchats = demandeAchatRepository.findDemandeAchatsByAcheteur(id);
...
/*   @GetMapping("/download/appointments.xlsx")
    ...
    @PostMapping("/addDemandeAchat/{idUser}")
    @ResponseBody
    public DemandeAchat addDemandeAchat (@RequestBody DemandeAchat d , @PathVariable("idUser")int idUser ){
        ...
        return iDemandeAchatService.addDemandeAchat(d  );
    }
    ...
    @PostMapping("CreateDemandeAchat/{idUser}")
    public DemandeAchat createDemandeAchat(@RequestBody DemandeAchat demandeAchat,@PathVariable("idUser")int idUser) {
        User user = userRepository.findById(idUser).orElse(null);
        demandeAchat.setAcheteur(user);
