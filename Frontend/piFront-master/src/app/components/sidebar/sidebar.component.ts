...
export const ROUTESACHETEUR: RouteInfo[] = [
  { path: '/dashboard', title: 'DashboardAcheteur',  icon: 'ni-tv-2 text-primary', class: '' },
  { path: '/demande-achat', title: 'Demande Achat',  icon:'ni-shop text-blue', class: '' },
  { path: '/demande-achat-acheteur', title: 'Mes demandes Achats',  icon:'ni-shop text-blue', class: '' },
