...
import { DemandeachatacheteurComponent } from "src/app/pages/demande-achat/demandeachatacheteur/demandeachatacheteur.component";
...
export const AdminLayoutRoutes: Routes = [
  ...
  {  path: 'demande-achat-acheteur', component: DemandeachatacheteurComponent}
];
